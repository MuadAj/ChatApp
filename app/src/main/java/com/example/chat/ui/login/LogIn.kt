...
import com.example.chat.ui.destinations.MainSecreenDestination
import com.example.chat.ui.destinations.SingUpScreenDestination
                ...
                Card(
                    ...
                    Column(
                        ...
                        Box(
                            ...
                            {
                                Text(text = "Forgot Password", color = Color(0xffff9431))
                            }
                        }
                        ...
                        Column(
                            ...
                            Button(
                                ...
                                onClick = { nav.navigate(MainSecreenDestination) }) {
                                Text(color = Color.White, text = "Log In", fontSize = 22.sp)
                            }

                            TextButton(onClick = { nav.navigate(SingUpScreenDestination) }
